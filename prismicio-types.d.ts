...
interface SettingsDocumentData {
  ...
  /**
   * Schwarz Architekten Logo field in *Settings*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.schwarz_architekten_logo
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  schwarz_architekten_logo: prismic.ImageField<never>;
}
 ...
 * Item in *test → adsf*
 */
export interface TestDocumentDataAdsfItem {}
...
interface TestDocumentData {
   ...
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: test.adsf[]
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  adsf: prismic.GroupField<Simplify<TestDocumentDataAdsfItem>>;
}
