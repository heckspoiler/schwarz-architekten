              ...
              <tr>
                  <td style="padding: 20px; text-align: center;">
                      <a href="https://www.schwarz-architekten.com/" style="display: inline-block; margin-bottom: 20px;">
                          <img src="https://i.ibb.co/PhpnTHP/SA-logo-pngreal.png" alt="SA-logo-pngreal" style="height: 60px; width: auto; border: 0;">
                      </a>
                      <h4 style="margin: 0; color: #000;">Guten Tag ${firstname} ${surname}</h4>
                  </td>
              </tr>
              <tr>
                  <td style="padding: 20px 30px; line-height: 1.6; text-align: justify; border-top: 3px solid #000; border-bottom: 3px solid #000;">
              ...
              <tr>
                  <td style="padding: 20px 30px; text-align: right;">
                      ...
                      <a href="https://www.schwarz-architekten.com/" style="display: inline-block; margin-top: 10px;">
                          <img src="https://i.ibb.co/PhpnTHP/SA-logo-pngreal.png" alt="SA-logo-pngreal" style="height: 20px; width: auto; border: 0;">
                      </a>
